...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    const-string v3, "Select band : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/settings/BandMode$1;->this$0:Lcom/android/settings/BandMode;

    #getter for: Lcom/android/settings/BandMode;->mTargetBand:Lcom/android/settings/BandMode$BandListItem;
    invoke-static {v3}, Lcom/android/settings/BandMode;->access$000(Lcom/android/settings/BandMode;)Lcom/android/settings/BandMode$BandListItem;
    ...
    #calls: Lcom/android/settings/BandMode;->log(Ljava/lang/String;)V
    invoke-static {v1, v2}, Lcom/android/settings/BandMode;->access$100(Lcom/android/settings/BandMode;Ljava/lang/String;)V

    .line 95
    iget-object v1, p0, Lcom/android/settings/BandMode$1;->this$0:Lcom/android/settings/BandMode;

    #getter for: Lcom/android/settings/BandMode;->mHandler:Landroid/os/Handler;
    invoke-static {v1}, Lcom/android/settings/BandMode;->access$200(Lcom/android/settings/BandMode;)Landroid/os/Handler;
    ...
    invoke-static {v1}, Lcom/android/settings/BandMode;->access$300(Lcom/android/settings/BandMode;)Lcom/android/internal/telephony/Phone;
