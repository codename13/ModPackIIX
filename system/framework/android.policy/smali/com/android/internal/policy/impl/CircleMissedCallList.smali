...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Lcom/android/internal/policy/impl/CircleMissedCallList;->mRingWidth:I
    ...
    iget v1, p0, Lcom/android/internal/policy/impl/CircleMissedCallList;->mLineEndY:I

    iget v2, p0, Lcom/android/internal/policy/impl/CircleMissedCallList;->mRingHeight:I
    ...
    .line 164
    iget-object v0, p0, Lcom/android/internal/policy/impl/CircleMissedCallList;->mRingDrawable:Landroid/graphics/drawable/Drawable;
...
.method public onHover(Landroid/view/MotionEvent;)V
    ...
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/CircleMissedCallList;->mWakeLockAcquired:Z
...
.method public updateMissedCall(I)V
    ...
    .prologue
    .line 106
    iget-object v6, p0, Lcom/android/internal/policy/impl/CircleMissedCallList;->mContext:Landroid/content/Context;

    invoke-static {v6}, Lcom/android/internal/policy/impl/CircleMissedEventDBAdapter;->getInstance(Landroid/content/Context;)Lcom/android/internal/policy/impl/CircleMissedEventDBAdapter;

    move-result-object v2

    .line 107
    .local v2, dbAdapter:Lcom/android/internal/policy/impl/CircleMissedEventDBAdapter;
    invoke-virtual {v2}, Lcom/android/internal/policy/impl/CircleMissedEventDBAdapter;->open()Lcom/android/internal/policy/impl/CircleMissedEventDBAdapter;

    .line 108
    invoke-virtual {v2}, Lcom/android/internal/policy/impl/CircleMissedEventDBAdapter;->getMissedCallCursor()Landroid/database/Cursor;
    ...
    .line 111
    .local v3, i:I
    iget-object v6, p0, Lcom/android/internal/policy/impl/CircleMissedCallList;->mList:Ljava/util/ArrayList;
    ...
    .line 132
    invoke-virtual {v2}, Lcom/android/internal/policy/impl/CircleMissedEventDBAdapter;->close()V

    .line 134
    iget-object v6, p0, Lcom/android/internal/policy/impl/CircleMissedCallList;->m_adapter:Lcom/android/internal/policy/impl/CircleMissedEventListAdapter;

    invoke-virtual {v6}, Lcom/android/internal/policy/impl/CircleMissedEventListAdapter;->notifyDataSetChanged()V
    ...
    const-string v6, "CircleMissedCallList"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "updateMissedCall : name = "
    ...
    new-instance v7, Lcom/android/internal/policy/impl/CircleMissedEventData;

    const/4 v8, 0x0

    invoke-direct {v7, v5, v8, v1}, Lcom/android/internal/policy/impl/CircleMissedEventData;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
